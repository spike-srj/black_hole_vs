...
//        FragColor = vec4(currentState.r-0.1, currentState.r,currentState.r, 1.0); // 灰度显示，问题出在LL/RR上
//        FragColor = vec4(final_escape_dir_world_calculated.x   , final_escape_dir_world_calculated.y ,final_escape_dir_world_calculated.z , 1.0); // 灰度显示，问题出在LL/RR上
